...
{
    public partial class GecmisKararlar : Form
    {
        public GecmisKararlar()
        {
            InitializeComponent();
        }
        ...
        private void GecmisKararlar_Load(object sender, EventArgs e)
        {
            Dts(dataGridView1);
            SqlConnection baglanti = new SqlConnection(baglantiCumlesi);
            baglanti.Open();

            string komutCumlesi = "Select Karar_Aciklamasi,Doktor From KararAciklamalari where DosyaNo = '" + HastaDosyaNo + "'";
